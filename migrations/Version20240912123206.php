 ...
 */
final class Version20240912123206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE network (id INT AUTO_INCREMENT NOT NULL, creator_id INT NOT NULL, name VARCHAR(120) NOT NULL, url VARCHAR(255) NOT NULL, INDEX IDX_608487BC61220EA6 (creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
